...
TEST_CASE("double precision omega function", "fabbri") {
    ...
    std::cout << "Solid (double precision) solid angle at test point:    " << omega(r) << std::endl;
...
TEST_CASE("multiprecision omega function", "fabbri") {
    ...
    std::cout << "Solid (multiprecision) solid angle at test point:      " << omega(r) << std::endl;
...
TEST_CASE("double precision we function", "fabbri") {
    ...
    std::cout << "Solid (double precision) we at test point:             " << we(r)    << std::endl;
...
TEST_CASE("multiprecision we function", "fabbri") {
    ...
    std::cout << "Solid (multiprecision) we at test point:               " << we(r)    << std::endl;
