...
#include <../include/amiga/vector3d.hpp>
#include "mpreal.h"
...
TEST_CASE("Test afold() function for 'double' type.", "Vector3D") {
...
TEST_CASE("Test afold() function for 'multiprecision' type.", "Vector3D") {
...
TEST_CASE("Test mfold() function for 'double' type.", "Vector3D") {
...
TEST_CASE("Test mfold() function for 'multiprecision' type.", "Vector3D") {
