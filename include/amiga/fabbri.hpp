 ...
 */
template<typename T>
using MagPosToScalarMap = std::function<T(const Vector3D<T>&, const Vector3D<T>&)>;
...
template<typename T>
PosToScalarMap<T>
new_omega_tri_fun(const Vector3D<T>& r1,
                  const Vector3D<T>& r2,
                  const Vector3D<T>& r3) {
...
template<typename T>
PosToScalarMap<T>
new_Wf_tri_fun(const Vector3D<T>& r1,
               const Vector3D<T>& r2,
               const Vector3D<T>& r3) {
  using std::array;
  using std::function;
...
template<typename T>
PosToVectorMap<T>
new_DWf_tri_fun(const Vector3D<T>& r1,
                const Vector3D<T>& r2,
                const Vector3D<T>& r3) {
  using std::array;
  using std::function;
...
template<typename T>
MagPosToScalarMap<T>
new_d_Wf_by_dm_tri_fun(const Vector3D<T>& r1,
                       const Vector3D<T>& r2,
                       const Vector3D<T>& r3) {
  using std::function;
...
template<typename T>
PosToScalarMap<T>
new_Lambda_f_fun(const Vector3D<T>& r1,
                 const Vector3D<T>& r2,
                 const Vector3D<T>& r3) {
  using std::array;
  using std::function;
...
template<typename T>
PosToVectorMap<T>
new_DLambda_f_fun(const Vector3D<T>& r1,
                  const Vector3D<T>& r2,
                  const Vector3D<T>& r3) {
  using std::array;
  using std::function;
...
template<typename T>
MagPosToVectorMap<T>
new_m_dot_DDLambda_f_fun(const Vector3D<T>& r1,
                         const Vector3D<T>& r2,
                         const Vector3D<T>& r3) {
  using std::array;
  using std::function;
  ...
  function<T(const Vector3D<T>&,
             const Vector3D<T>&)> d_Wf_dm = new_d_Wf_by_dm_tri_fun(r1,
    r2,
    r3);
...
template<typename T>
PosToScalarMap<T>
new_uni_tet_phi_fun(const Vector3D<T>& M,
                    const Vector3D<T>& r1,
                    const Vector3D<T>& r2,
                    const Vector3D<T>& r3,
                    const Vector3D<T>& r4) {
...
template<typename T>
PosToVectorMap<T>
new_lin_tet_A_fun(const Vector3D<T>& M,
                  const Vector3D<T>& r1,
                  const Vector3D<T>& r2,
                  const Vector3D<T>& r3,
                  const Vector3D<T>& r4) {
  // TODO: Implement this!
  return [](const Vector3D<T>& r) {
  };
}
} // namespace amiga
